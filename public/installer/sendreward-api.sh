#!/bin/bash
# sendreward-api.sh — wrapper sudo chamado por api_cls.php (Apache/PHP).
#
# Lê JSON do STDIN, delega para /usr/local/bin/pw_send_mail.php executando
# como root (necessário para console do gdeliveryd / sockets locais), e
# devolve a resposta no STDOUT.
#
